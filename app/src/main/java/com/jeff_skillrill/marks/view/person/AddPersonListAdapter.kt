...
import com.jeff_skillrill.marks.viewModel.person.AddPersonListViewModel

class AddPersonListAdapter(var data: LiveData<List<PersonModel>>,
                           var viewModel: AddPersonListViewModel
): RecyclerView.Adapter<AddPersonListAdapter.Holder>() {
